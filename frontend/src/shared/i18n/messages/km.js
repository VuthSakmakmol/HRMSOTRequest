...
export default {
  ...
  nav: {
    ...
    attendanceScanStation: 'ស្ថានីយស្កេនវត្តមាន',
    attendanceScanLogs: 'កំណត់ហេតុស្កេនវត្តមាន',
    ...
    otApprovalCalendarRules: 'កំណត់លំហូរអនុម័តតាមប្រតិទិន',
  ...
  attendance: {
    ...
    scanStation: {
      title: 'ស្ថានីយស្កេនវត្តមាន',
      subtitle: 'បើកទំព័រនេះនៅកុំព្យូទ័រស្កេន។ គាំទ្រម៉ាស៊ីនស្កេនដែលផ្ញើ Enter និងមិនផ្ញើ Enter។',
      scanCard: 'រួចរាល់សម្រាប់ស្កេនកាតបុគ្គលិក',
      scanCardHelp: 'ស្កេនកាតបុគ្គលិក។ មាន Enter នឹងបញ្ជូនភ្លាមៗ; មិនមាន Enter នឹងបញ្ជូនដោយស្វ័យប្រវត្តិបន្ទាប់ពីស្កេនឈប់។',
      placeholder: 'ស្កេនលេខសម្គាល់បុគ្គលិក',
      inputHelp: 'ប្រអប់ស្កេននៅតែផ្តោត និងគាំទ្រម៉ាស៊ីនស្កេនទាំងពីរប្រភេទ។',
      readyTitle: 'រួចរាល់សម្រាប់កាតបន្ទាប់',
      readyHelp: 'ស្កេនកាតបុគ្គលិកសកម្ម ដើម្បីកត់ត្រាវត្តមាន។',
      recordedTitle: 'បានកត់ត្រាវត្តមាន',
      errorTitle: 'កាតមានបញ្ហា — មិនបានកត់ត្រាវត្តមាន',
      officialTime: 'វត្តមានផ្លូវការ: ចូល {scanIn} · ចេញ {scanOut}',
      paperInstruction: 'សូមផ្តល់ក្រដាសវត្តមានដោយដៃទៅកាន់សន្តិសុខ។',
      errorDefault: 'មិនស្គាល់កាតនេះទេ។',
      systemError: 'មិនអាចរក្សាទុកការស្កេនបានទេ។ សូមព្យាយាមម្តងទៀត។',
      recentScans: 'ការស្កេនចុងក្រោយនៅស្ថានីយនេះ',
      focusInput: 'ផ្តោតកន្លែងស្កេន',
      noScansYet: 'មិនទាន់មានកាតត្រូវបានស្កេនក្នុងកម្មវិធីរុករកនេះទេ។',
    },

    scanLogs: {
      title: 'កំណត់ហេតុស្កេនវត្តមាន',
      subtitle: 'កំណត់ហេតុស្កេនដោយស្វ័យប្រវត្តិ។ សន្តិសុខមិនចាំបាច់បញ្ចូលទិន្នន័យនៅទីនេះទេ។',
      totalScans: 'ចំនួនស្កេនសរុប',
      validScans: 'ស្កេនត្រឹមត្រូវ',
      failedScans: 'ស្កេនបរាជ័យ',
      uniqueErrorCards: 'កាតមានបញ្ហាផ្សេងគ្នា',
      allResults: 'លទ្ធផលស្កេនទាំងអស់',
      searchPlaceholder: 'ស្វែងរកបុគ្គលិក លេខកាត មូលហេតុ ឬស្ថានីយ',
      logCount: 'កំណត់ហេតុ',
      loadFailed: 'មិនអាចផ្ទុកកំណត់ហេតុស្កេនបានទេ។',
      noLogs: 'មិនមានកំណត់ហេតុស្កេនតាមតម្រងទេ។',
      scanTime: 'ម៉ោងស្កេន',
      rawCardValue: 'តម្លៃកាតដែលស្កេនបាន',
      reason: 'មូលហេតុ',
      station: 'ស្ថានីយ',
      result: {
        success: 'ជោគជ័យ',
        employeeNotFound: 'មិនស្គាល់កាត',
        inactive: 'បុគ្គលិកមិនសកម្ម',
        invalidFormat: 'តម្លៃកាតមិនត្រឹមត្រូវ',
    ...
    importDialog: {
      ...
      guideStep4: 'ជ្រើសឯកសារ ហើយនាំចូល។ បើមានស្ទួន ឬកំហុស ប្រព័ន្ធនឹងបដិសេធទាំងអស់។ វត្តមានពីស្ថានីយស្កេននឹងត្រូវបានការពារ។',
      note:
    ...
    option: {
      ...
      allSources: 'ប្រភពទាំងអស់',
    },

    source: {
      scanStation: 'ស្ថានីយស្កេន',
      import: 'នាំចូល Excel',
    },
  ...
  ot: {
    approvalCalendarRules: {
      pageTitle: 'លំហូរអនុម័ត OT តាមប្រតិទិន',
      calendarWorkflow: 'លំហូរតាមប្រតិទិន',
      rulesConfigured: 'បានកំណត់ {count}',
      reload: 'ផ្ទុកឡើងវិញ',
      addWorkflowPerson: 'បន្ថែមអ្នកក្នុងលំហូរ',
      ...
      sunday: 'ថ្ងៃអាទិត្យ',
      holiday: 'ថ្ងៃឈប់សម្រាក',
      useEmployeeDefault: 'ប្រើតួនាទីលំនាំដើម',
      approver: 'អ្នកអនុម័ត',
      finalApprover: 'អ្នកអនុម័តចុងក្រោយ',
      acknowledge: 'ទទួលជ្រាប',
      skip: 'មិនអនុវត្ត',
      reset: 'កំណត់ឡើងវិញ',
      saving: 'កំពុងរក្សាទុក',
      viewOnly: 'មើលបានតែប៉ុណ្ណោះ',
      accessDenied: 'គ្មានសិទ្ធិចូលប្រើ',
      accessDeniedDetail: 'អ្នកមិនមានសិទ្ធិមើលទំព័រនេះទេ។',
      loading: 'កំពុងផ្ទុកការកំណត់លំហូរអនុម័ត',
      noRules: 'មិនទាន់មានការកំណត់លំហូរ',
      unknownEmployee: 'មិនស្គាល់បុគ្គលិក',
      loadFailed: 'ផ្ទុកមិនបានសម្រេច',
      loadFailedDetail: 'មិនអាចផ្ទុកការកំណត់លំហូរអនុម័ត OT បានទេ។',
      employeeSearchFailed: 'ស្វែងរកបុគ្គលិកមិនបានសម្រេច',
      employeeSearchFailedDetail: 'មិនអាចផ្ទុកបញ្ជីបុគ្គលិកបានទេ។',
      ruleSaved: 'បានរក្សាទុក',
      ruleSavedDetail: 'បានធ្វើបច្ចុប្បន្នភាព {employee} រួចរាល់។',
      saveFailed: 'រក្សាទុកមិនបានសម្រេច',
      saveFailedDetail: 'មិនអាចរក្សាទុកការកំណត់លំហូរអនុម័តនេះបានទេ។',
      ruleReset: 'បានកំណត់ឡើងវិញ',
      ruleResetDetail: '{employee} កំពុងប្រើតួនាទីលំនាំដើម។',
      resetFailed: 'កំណត់ឡើងវិញមិនបានសម្រេច',
      resetFailedDetail: 'មិនអាចកំណត់លំហូរអនុម័តនេះឡើងវិញបានទេ។',
    },
