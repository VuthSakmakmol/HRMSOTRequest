...
export default {
  ...
  nav: {
    ...
    attendanceScanStation: 'จุดสแกนเวลาเข้างาน',
    attendanceScanLogs: 'บันทึกการสแกนเวลาเข้างาน',
    ...
    otApprovalCalendarRules: 'กฎการอนุมัติตามปฏิทิน',
  ...
  attendance: {
    ...
    scanStation: {
      title: 'จุดสแกนเวลาเข้างาน',
      subtitle: 'เปิดหน้านี้ไว้ที่คอมพิวเตอร์สแกน รองรับทั้งเครื่องสแกนที่ส่ง Enter และไม่ส่ง Enter',
      scanCard: 'พร้อมสแกนบัตรพนักงาน',
      scanCardHelp: 'สแกนบัตรพนักงาน หากมี Enter ระบบจะส่งทันที; หากไม่มี Enter ระบบจะส่งอัตโนมัติหลังการสแกนหยุด',
      placeholder: 'สแกนรหัสพนักงาน',
      inputHelp: 'ช่องสแกนคงโฟกัสไว้และรองรับเครื่องสแกนทั้งสองประเภท',
      readyTitle: 'พร้อมสำหรับบัตรใบถัดไป',
      readyHelp: 'สแกนบัตรพนักงานที่ใช้งานอยู่เพื่อบันทึกเวลา',
      recordedTitle: 'บันทึกเวลาเข้างานแล้ว',
      errorTitle: 'บัตรมีปัญหา — ไม่ได้บันทึกเวลา',
      officialTime: 'เวลาทางการ: เข้า {scanIn} · ออก {scanOut}',
      paperInstruction: 'กรุณาส่งเอกสารลงเวลาที่เขียนด้วยมือให้ Security',
      errorDefault: 'ไม่รู้จักบัตรนี้',
      systemError: 'ไม่สามารถบันทึกการสแกนได้ กรุณาลองใหม่',
      recentScans: 'การสแกนล่าสุดที่จุดนี้',
      focusInput: 'โฟกัสเครื่องสแกน',
      noScansYet: 'ยังไม่มีการสแกนบัตรในเบราว์เซอร์นี้',
    },

    scanLogs: {
      title: 'บันทึกการสแกนเวลาเข้างาน',
      subtitle: 'ประวัติการสแกนอัตโนมัติ Security ไม่ต้องกรอกข้อมูลที่นี่',
      totalScans: 'สแกนทั้งหมด',
      validScans: 'สแกนถูกต้อง',
      failedScans: 'สแกนไม่สำเร็จ',
      uniqueErrorCards: 'บัตรปัญหาไม่ซ้ำกัน',
      allResults: 'ผลการสแกนทั้งหมด',
      searchPlaceholder: 'ค้นหาพนักงาน ค่าบัตร เหตุผล หรือจุดสแกน',
      logCount: 'บันทึก',
      loadFailed: 'ไม่สามารถโหลดบันทึกการสแกนได้',
      noLogs: 'ไม่พบบันทึกการสแกนตามตัวกรอง',
      scanTime: 'เวลาสแกน',
      rawCardValue: 'ค่าบัตรที่สแกน',
      reason: 'เหตุผล',
      station: 'จุดสแกน',
      result: {
        success: 'สำเร็จ',
        employeeNotFound: 'ไม่พบบัตร',
        inactive: 'พนักงานไม่ใช้งาน',
        invalidFormat: 'ค่าบัตรไม่ถูกต้อง',
    ...
    importDialog: {
      ...
      guideStep3: 'กรอกเฉพาะ Employee ID, Clock In และ Clock Out ให้เหมือนตัวอย่าง',
      guideStep4: 'เลือกไฟล์และนำเข้า หากมีแถวซ้ำหรือผิดพลาด ระบบจะปฏิเสธทั้งไฟล์ ข้อมูลจากจุดสแกนจะได้รับการป้องกัน',
      note:
        'เลือกวันที่เข้างานในหน้าต่างนำเข้า ไฟล์ตัวอย่างไม่ต้องมีคอลัมน์วันที่ การนำเข้าจะแทนที่วันที่เข้างานที่เลือก ดังนั้นพนักงานที่ไม่อยู่ในไฟล์ใหม่จะถูกลบออกสำหรับวันนั้น',
  ...
  ot: {
    approvalCalendarRules: {
      pageTitle: 'กฎการอนุมัติ OT ตามปฏิทิน',
      calendarWorkflow: 'เวิร์กโฟลว์ตามปฏิทิน',
      rulesConfigured: 'ตั้งค่าแล้ว {count}',
      reload: 'รีเฟรช',
      addWorkflowPerson: 'เพิ่มผู้รับผิดชอบเวิร์กโฟลว์',
      searchPlaceholder: 'ค้นหารหัสพนักงานหรือชื่อ',
      selectEmployee: 'เลือกพนักงาน',
      add: 'เพิ่ม',
      workingDay: 'วันทำงาน',
      sunday: 'วันอาทิตย์',
      holiday: 'วันหยุด',
      useEmployeeDefault: 'ใช้บทบาทเริ่มต้นของพนักงาน',
      approver: 'ผู้อนุมัติ',
      finalApprover: 'ผู้อนุมัติขั้นสุดท้าย',
      acknowledge: 'รับทราบ',
      skip: 'ไม่ใช้',
      reset: 'รีเซ็ต',
      saving: 'กำลังบันทึก',
      ...
      accessDeniedDetail: 'คุณไม่มีสิทธิ์ดูหน้านี้',
      loading: 'กำลังโหลดกฎการอนุมัติ',
      noRules: 'ยังไม่มีกฎการอนุมัติ',
      unknownEmployee: 'ไม่ทราบพนักงาน',
      loadFailed: 'โหลดไม่สำเร็จ',
      loadFailedDetail: 'ไม่สามารถโหลดกฎการอนุมัติ OT ตามปฏิทินได้',
      employeeSearchFailed: 'ค้นหาพนักงานไม่สำเร็จ',
      employeeSearchFailedDetail: 'ไม่สามารถโหลดรายชื่อพนักงานได้',
      ruleSaved: 'บันทึกกฎแล้ว',
      ruleSavedDetail: 'อัปเดต {employee} แล้ว',
      saveFailed: 'บันทึกไม่สำเร็จ',
      saveFailedDetail: 'ไม่สามารถบันทึกกฎการอนุมัตินี้ได้',
      ruleReset: 'รีเซ็ตกฎแล้ว',
      ruleResetDetail: '{employee} ใช้บทบาทเวิร์กโฟลว์เริ่มต้นแล้ว',
      resetFailed: 'รีเซ็ตไม่สำเร็จ',
      resetFailedDetail: 'ไม่สามารถรีเซ็ตกฎการอนุมัตินี้ได้',
    },
