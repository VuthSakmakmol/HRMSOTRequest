...
export default {
  ...
  nav: {
    ...
    attendanceScanStation: 'Attendance Scan Station',
    attendanceScanLogs: 'Attendance Scan Logs',
    ...
    otApprovalCalendarRules: 'Approval Calendar Rules',
  ...
  attendance: {
    ...
    scanStation: {
      ...
      subtitle: 'Keep this page open at the scan computer. It supports scanners with Enter and scanners without Enter.',
      scanCard: 'Ready to scan employee card',
      scanCardHelp: 'Scan the employee card. With Enter it submits immediately; without Enter it submits automatically after the scan stops.',
      placeholder: 'Scan Employee ID',
      inputHelp: 'The scan field stays focused and supports both scanner types.',
      readyTitle: 'Ready for next card',
      readyHelp: 'Scan a valid active employee card to record attendance.',
      recordedTitle: 'Attendance recorded',
      errorTitle: 'Card error — attendance not recorded',
      officialTime: 'Official attendance: Scan In {scanIn} · Scan Out {scanOut}',
      paperInstruction: 'Please provide your manual attendance paper to Security.',
      errorDefault: 'Card was not recognized.',
      systemError: 'Unable to save this scan. Please try again.',
      recentScans: 'Latest scans on this station',
      focusInput: 'Focus scanner',
      noScansYet: 'No card has been scanned in this browser session yet.',
    },

    scanLogs: {
      title: 'Attendance Scan Logs',
      subtitle: 'Automatic scanner audit. Security does not need to enter or resolve anything here.',
      totalScans: 'Total scans',
      validScans: 'Valid scans',
      failedScans: 'Failed scans',
      uniqueErrorCards: 'Unique error cards',
      allResults: 'All scan results',
      searchPlaceholder: 'Search employee, scanned card value, reason, or station',
      logCount: 'logs',
      loadFailed: 'Failed to load attendance scan logs.',
      noLogs: 'No scanner logs matched your filters.',
      scanTime: 'Scan Time',
      rawCardValue: 'Scanned Card Value',
      reason: 'Reason',
      station: 'Station',
      result: {
        success: 'Success',
        employeeNotFound: 'Card not recognized',
        inactive: 'Inactive employee',
        invalidFormat: 'Invalid card value',
    ...
    importDialog: {
      ...
      guideStep4: 'Choose the file and import. Duplicate/error rows reject the whole file. Existing Scan Station attendance is protected.',
      note:
        'Attendance date is selected in the dialog. The Excel sample does not need a date column. Import fills or replaces matching employee-day rows only and never overwrites Scan Station attendance.',
  ...
  ot: {
    approvalCalendarRules: {
      pageTitle: 'OT Approval Calendar Rules',
      calendarWorkflow: 'Calendar workflow',
      rulesConfigured: '{count} configured',
      reload: 'Reload',
      addWorkflowPerson: 'Add workflow person',
      ...
      sunday: 'Sunday',
      holiday: 'Holiday',
      useEmployeeDefault: 'Use employee default',
      approver: 'Approver',
      ...
      viewOnly: 'View only',
      accessDenied: 'Access denied',
      accessDeniedDetail: 'You do not have permission to view this page.',
      loading: 'Loading approval rules',
      noRules: 'No approval rules',
      unknownEmployee: 'Unknown employee',
      loadFailed: 'Load failed',
      loadFailedDetail: 'Could not load OT approval calendar rules.',
      employeeSearchFailed: 'Employee search failed',
      employeeSearchFailedDetail: 'Could not load employee choices.',
      ruleSaved: 'Rule saved',
      ruleSavedDetail: '{employee} has been updated.',
      saveFailed: 'Save failed',
      saveFailedDetail: 'Could not save this approval calendar rule.',
      ruleReset: 'Rule reset',
      ruleResetDetail: '{employee} now uses the default workflow role.',
      resetFailed: 'Reset failed',
      resetFailedDetail: 'Could not reset this approval calendar rule.',
    },
